        ...
        <div className=" bg-white rounded-2xl shadow-2xl flex w-5/6 max-w-6xl ">
          <div className="w-3/5 p-5 rounded-tl-2xl rounded-bl-2xl text-purple-500 relative" style={{ backgroundColor: "#E4E4E4" }}>
            ...
            <form className="flex flex-wrap">
              ...
              <div className="pl-72">
                <button className="hover:bg-white hover:text-purple-950 text-white font-bold py-2 px-4 rounded mt-4" style={{ background: "#222222" }} type="submit">
                  SIGNUP
                </button>
              </div>
            </form>
          ...
          <div className="w-2/5 p-5 rounded-tr-2xl rounded-br-2xl py-40 px-12" style={{ backgroundColor: "#222222", color: "#045757" }}>
            ...
            <Link href="/user/login" className="hover:bg-white hover:text-teal-700 text-black font-bold py-2 px-4 rounded mt-4" style={{ background: "#E4E4E4" }}>
              LOGIN
            </Link>
          </div>
        </div>
